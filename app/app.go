...
import (
	...
	appparams "github.com/bytejedi/ledger/app/params"
	"github.com/bytejedi/ledger/x/ledger"
	ledgerkeeper "github.com/bytejedi/ledger/x/ledger/keeper"
	ledgertypes "github.com/bytejedi/ledger/x/ledger/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/ledgerd")
	}
...
func New(
	...
	app.ledgerKeeper = *ledgerkeeper.NewKeeper(
        appCodec, keys[ledgertypes.StoreKey], keys[ledgertypes.MemStoreKey],
	)
